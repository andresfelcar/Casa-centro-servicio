            ...
            <div class="load-animate animated fadeInUp">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
                        ...
                        <div class="form-group">
                            ...
                            <select name="companyName" id="companyName" class="form-control mi-selector" required
                                ...
                                <option value="<?php echo $items[0]; ?>"><?php echo $items[2]; ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                        ...
                        <table class="table table-bordered table-hover" id="invoiceItem">
                            <tr>
                                <th scope="col" class="letra-blanca" width="1%"><input id="checkAll" class="formcontrol"
                                        type="checkbox"></th>
                                <th scope="col" class="letra-blanca" width="25%">Nombre Producto</th>
                                ...
                                <th scope="col" class="letra-blanca" width="25%">Tiras</th>
                                <th scope="col" class="letra-blanca" width="5%">No.Tiras</th>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="total[]" id="total_1" class="form-control total"
                                        ...
                                        <td>
                                        <select name="productosTiras[]" id="productosTiras_1" class="form-control"
                                        onchange="javascript:selectTiras(this.value,1);">
                                        <option selected>Seleccione alguno</option>
                                        <?php
                                        $result = $invoice->Products(0);
                                        ...
                                        <td><input type="number" name="cantidadTiras[]" id="cantidadTiras_1" class="form-control total" onchange="javascript:validateQuantity(this.value,1);"></td>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        <h3>Notas: </h3>
                        <div class="form-group">
                            <textarea value="" class="form-control txt" rows="5" name="notes" id="notes"
                                placeholder="Notas">Empaque Con Medida:</textarea>
                        </div>
                        <br>
                        <div class="form-group">
