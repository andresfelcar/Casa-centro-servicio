                ...
                <tbody>
                    <?php
                     ...
                     <?php if($mostrar[0]==87){ ?>
                        ...
                        <td>
                            <p><strong><?php echo $mostrar[0] ?></strong></p>
                        </td>
                        <td>
                            <p><strong><?php echo $mostrar[1] ?></strong></p>
                        </td>
                        <td>
                            <p><strong><?php echo $mostrar[2] ?></strong></p>
                        </td>
                        <td>
                            <p><strong><?php echo $mostrar[3] ?></strong></p>
                        </td>
                        
                        <td><a href="Edit_Producto.php?update_id=<?php echo $mostrar[0] ?>" title="Editar Factura">
                                <div class="btn fondo-amarillo"><span class="glyphicon glyphicon-edit"></span></div>
                            </a></td>
                            <td class="td"><a href="delete_product.php?delete_id=<?php echo $mostrar[0] ?>"  title="Borrar Producto">
