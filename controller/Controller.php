...
require_once "Gastos_Controller.php";
require_once "Tiras_Controller.php";
...
class Controller{
    ...
    public function Gastos($option,$array = []){
        return Gastos_Controller::Main($option,$array);
    }
    public function Tiras($option,$array = []){
        return Tiras_Controller::Main($option,$array);
    }
}
