   ...
   <div class="menu-usuario"><?php include('menu.php'); ?></div>
    ...
    <div class="container-fluid">
        ...
        <table id="data-table" class="table">
            <thead>
                <tr>
                    <th scope="col" class="letra-blanca" width="10%">Codigo Tira</th>
                    <th scope="col" class="letra-blanca" width="30%">Referencia Tira</th>
                    <th scope="col" class="letra-blanca" width="30%">Tiras Gastadas</th>
                 
                </tr>
            </thead>
            <?php
             if (!empty($_POST['dia'])) {
                $result = $invoice->ProductsList(2,$_POST['dia']);
                while($resultado = $result->fetch_array()) {
                    echo "<tr>
                    <td>$resultado[0]</td>
                    <td>$resultado[3]</td>
